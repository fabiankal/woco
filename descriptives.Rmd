...
ggsave("./output/figures/figure1_stack_gesundh.png", units="in", width=6.8, height=4, type="cairo-png")
...
ggsave("./output/figures/figure1_mean_gesundh.png", units="in", width=8, height=5, type="cairo-png")

write.csv(data_plot_long, "./output/tables/figure1_shares.csv", na = "NA")
write.csv(data_plot_long_mean, "./output/tables/figure1_mean.csv", na = "NA")
write.csv(data_plot_long_N, "./output/tables/figure1_observations.csv", na = "NA")
