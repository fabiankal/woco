...
bern_data_long2_factored = readRDS("Y:/Wirtschaftssoziologie/Corona/Corona_Panel_Analyse/data/processed/W1-24_CORONAPANEL_recoded.rds")
...
### Einschätzung der gesundheitlichen Gefahr - datawrapper

```{r gesundheitliche Gefahr, echo=FALSE, fig.width=8, fig.height=5, results='asis'}
#GESUNDHEITLICH#########################
...
### Einschätzung der gesundheitlichen Gefahr - shiny
...
data_long <- gather(lr_gen_w1, variable, measurement, c(ges_per_gefahr,ges_pub_gefahr,wir_per_gefahr,wir_pub_gefahr), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)

data_plot_long_N<-data_long %>% filter(!is.na(measurement)) %>% 
 group_by(wavedate,variable) %>% tally() %>% rename(N_total=n)

levels(data_plot_long_N$variable) <- c("Ges. Gefahr Persönlich", "Ges. Gefahr Für die österr. Bevölkerung"," Wir. Gefahr Persönlich", "Wir. Gefahr Für die österr. Bevölkerung")
...
data_plot_long<-data_plot_long %>% group_by(wavedate,variable) %>%
     mutate(prop = n/sum(n),ymax=prop+1.96*sqrt(n/sum(n))*(1-(n/sum(n)))/n, ymin=prop-1.96*sqrt(n/sum(n))*(1-(n/sum(n)))/n,groupby="none")

levels(data_plot_long$variable) <- c("Ges. Gefahr Persönlich", "Ges. Gefahr Für die österr. Bevölkerung"," Wir. Gefahr Persönlich", "Wir. Gefahr Für die österr. Bevölkerung")
levels(data_plot_long$measurement) <- c("sehr groß", "groß", "mittelmäßig", "klein", "sehr klein")
...
data_plot_long_mean <- data_long  %>% filter(!is.na(measurement)) %>%
  ...
  summarise(mean_measurement=survey_mean(6-as.numeric(measurement),vartype = c("se"))) %>% group_by(wavedate,variable) %>%
...
#mean by Gender
data_plot_long_mean_ge <- data_long  %>% filter(!is.na(measurement)&!is.na(gender)) %>%
  as_survey_design(weights = c(WEIGHTD)) %>%
  group_by(wavedate,variable,gender) %>%
  summarise(mean_measurement=survey_mean(6-as.numeric(measurement),vartype = c("se"))) %>% group_by(wavedate,variable,gender) %>%
     mutate(ymax=mean_measurement+1.96*mean_measurement_se, ymin=mean_measurement-1.96*mean_measurement_se,groupby="ge")

#mean by Age
data_plot_long_mean_ag <- data_long  %>% filter(!is.na(measurement)&!is.na(alter_g)) %>%
  as_survey_design(weights = c(WEIGHTD)) %>%
  group_by(wavedate,variable,alter_g) %>%
  summarise(mean_measurement=survey_mean(6-as.numeric(measurement),vartype = c("se"))) %>% group_by(wavedate,variable,alter_g) %>%
     mutate(ymax=mean_measurement+1.96*mean_measurement_se, ymin=mean_measurement-1.96*mean_measurement_se,groupby="ag")

#mean by Education
data_plot_long_mean_ed <- data_long  %>% filter(!is.na(measurement)&!is.na(edu4)) %>%
  as_survey_design(weights = c(WEIGHTD)) %>%
  group_by(wavedate,variable,edu4) %>%
  summarise(mean_measurement=survey_mean(6-as.numeric(measurement),vartype = c("se"))) %>% group_by(wavedate,variable,edu4) %>%
     mutate(ymax=mean_measurement+1.96*mean_measurement_se, ymin=mean_measurement-1.96*mean_measurement_se,groupby="ed")

#mean by Region
data_plot_long_mean_bl <- data_long  %>% filter(!is.na(measurement)&!is.na(bula)) %>%
  as_survey_design(weights = c(WEIGHTD)) %>%
  group_by(wavedate,variable,bula) %>%
  summarise(mean_measurement=survey_mean(6-as.numeric(measurement),vartype = c("se"))) %>% group_by(wavedate,variable,bula) %>%
...
data_plot_long_mean_hi <- data_long  %>% filter(!is.na(measurement)&!is.na(hh_inc_cur_quintile)) %>%
  as_survey_design(weights = c(WEIGHTD)) %>%
  group_by(wavedate,variable,hh_inc_cur_quintile) %>%
  summarise(mean_measurement=survey_mean(6-as.numeric(measurement),vartype = c("se"))) %>% group_by(wavedate,variable,hh_inc_cur_quintile) %>%
...
levels(data_plot_long_mean_ge$variable) <- c("Ges. Gefahr Persönlich", "Ges. Gefahr Für die österr. Bevölkerung"," Wir. Gefahr Persönlich", "Wir. Gefahr Für die österr. Bevölkerung")
levels(data_plot_long_mean_ag$variable) <- c("Ges. Gefahr Persönlich", "Ges. Gefahr Für die österr. Bevölkerung"," Wir. Gefahr Persönlich", "Wir. Gefahr Für die österr. Bevölkerung")
levels(data_plot_long_mean_ed$variable) <- c("Ges. Gefahr Persönlich", "Ges. Gefahr Für die österr. Bevölkerung"," Wir. Gefahr Persönlich", "Wir. Gefahr Für die österr. Bevölkerung")
levels(data_plot_long_mean_bl$variable) <- c("Ges. Gefahr Persönlich", "Ges. Gefahr Für die österr. Bevölkerung"," Wir. Gefahr Persönlich", "Wir. Gefahr Für die österr. Bevölkerung")
levels(data_plot_long_mean_hi$variable) <- c("Ges. Gefahr Persönlich", "Ges. Gefahr Für die österr. Bevölkerung"," Wir. Gefahr Persönlich", "Wir. Gefahr Für die österr. Bevölkerung")

#export_shiny_data <- left_join(data_plot_long, data_plot_long_mean,by=c("wavedate"="wavedate","variable"="variable"))

data_plot_long_mean_ge<-data_plot_long_mean_ge%>%rename("subgroup" = gender)
data_plot_long_mean_ag<-data_plot_long_mean_ag%>%rename("subgroup" = alter_g)
data_plot_long_mean_ed<-data_plot_long_mean_ed%>%rename("subgroup" = edu4)
data_plot_long_mean_bl<-data_plot_long_mean_bl%>%rename("subgroup" = bula)
data_plot_long_mean_hi<-data_plot_long_mean_hi%>%rename("subgroup" = hh_inc_cur_quintile)

export_shiny_data <- bind_rows(data_plot_long_mean, data_plot_long_mean_ge)
export_shiny_data <- bind_rows(export_shiny_data, data_plot_long_mean_ag)
export_shiny_data <- bind_rows(export_shiny_data, data_plot_long_mean_ed)
export_shiny_data <- bind_rows(export_shiny_data, data_plot_long_mean_bl)
export_shiny_data <- bind_rows(export_shiny_data, data_plot_long_mean_hi)


export_shiny_data <- left_join(export_shiny_data, data_plot_long_N,by=c("wavedate"="wavedate","variable"="variable"))
...
export_shiny_data_shares <- left_join(data_plot_long, data_plot_long_N,by=c("wavedate"="wavedate","variable"="variable"))
...
```{r wirtschaftliche gefahr, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#WIRTSCHAFTLICH#########################
...
#data_plot_long$wave<-as.factor(data_plot_long$wave)
#levels(data_plot_long_mean$wave ) <- c("W1", "W2", "W3","W4","W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
levels(data_plot_long_mean$condition) <- c("Persönlich", "Für die österr. Bevölkerung")
#levels(data_plot_long$measurement) <- c("sehr groß", "groß", "mittelmäßig", "klein", "sehr klein")
...
```{r gesundheitliche GefahrnAlter, echo=FALSE, fig.width=8, fig.height=5, results='asis'}
#GESUNDHEITLICH#########################
...
```{r wirtschaftliche gefahrnAlter, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#WIRTSCHAFTLICH#########################
...
```{r ansteckungsgefahr, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#ansteckungsgefahr###################################################
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
#levels(data_plot_long_mean$wave ) <- c("W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
```{r corona_ampel, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#corona_ampel###################################################
...
```{r testen, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W19","W20","W21","W22","W23","W24")
...
#levels(data_plot_long_mean$wave) <-c("W19","W20","W21","W22","W23","W24")
...
```{r test_einstell, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#(Massen)test Einstellungen###################################################
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W18","W19","W20","W21","W22","W23","W24")
...
#levels(data_plot_long_mean$wave) <-c("W18","W19","W20","W21","W22","W23","W24")
...
```{r impfstatus, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#Impfung erhalten###################################################

lr_gen_w1 <- bern_data_long2_factored %>% filter(!is.na(WEIGHTD)) # droppen der aussteiger 

data_long <- gather(lr_gen_w1, condition, measurement, c(geimpft), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W21","W22","W23","W24")
levels(data_plot_long$condition) <- c("Wurde bereits geimpft")
#levels(data_plot_long$measurement) <- c("Trifft voll und ganz zu", "Trifft eher zu", "Teils-teils", "Trifft eher nicht zu", "Trifft gar nicht zu","Kenne die Corona-Ampel nicht")
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W22","W23","W24")
...
```{r impfbereits, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#Impfung###################################################
...
#levels(data_plot_long_mean$wave) <-c("W21","W22","W23","W24")
...
```{r impfung, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#Impfung###################################################


lr_gen_w1 <- bern_data_long2_factored %>% filter(!is.na(WEIGHTD)) # droppen der aussteiger 

data_long <- gather(lr_gen_w1, condition, measurement, c(impf_ehe,impf_pfl,impf_gra,impf_pfb,impf_sof,impf_unf,impf_soz), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W9","W16","W18","W19","W21","W22","W23","W24")
...
#levels(data_plot_long_mean$wave) <-c("W9","W16","W18","W19","W21","W22","W23","W24")
...
```{r impf_einstell, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#IMpfung Einstellungen###################################################


lr_gen_w1 <- bern_data_long2_factored %>% filter(!is.na(WEIGHTD)) # droppen der aussteiger 

data_long <- gather(lr_gen_w1, condition, measurement, c(impfe_sor,impfe_imm,impfe_ini,impfe_leb,impfe_asc,impfe_aim,impfe_ssc,impfe_sic,impfe_inb,impfe_str), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W18","W21","W22","W23","W24")
...
#levels(data_plot_long_mean$wave) <-c("W18","W21","W22","W23","W24")
...
```{r umgangcorona, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#(Massen)test Einstellungen###################################################
...
levels(data_plot_long_mean$wave) <-c("W20")
levels(data_plot_long_mean$condition) <- c("Strengere Maßnahmen\nfür Personen\nohne Test","Möglichst harte\nMaßnahmen für \n kürzere Krise", "Maßnahmen erst\n lockern wenn\nInfektionen bei Null","Sobald Risikogruppen\n geimpft \nalles öffnen","Alle Beschränkungen\naufheben und auf\nEigenverantwortung setzen.","Maßnahmen lockern\nauch wenn mehr\nCorona-Infizierte")
cat("  \n")
...
```{r latente Deprivation, echo=FALSE, fig.width=8, fig.height=5, results='asis'}  
#latente deprivation###################################################
...
```{r depression, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r ausgehgrunde, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r ausgehgrunde blog, echo=FALSE, fig.width=8, fig.height=5, include= FALSE, eval=FALSE}  
...
```{r ausgehgrunde blog2, echo=FALSE, fig.width=8, fig.height=5, include= TRUE}
...
```{r kontakth, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r zweite_welle, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r zusammenhalt, echo=FALSE, fig.width=8, fig.height=5}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W1", "W2", "W3","W4","W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
#levels(data_plot_long_mean$wave ) <- c("W1", "W2", "W3","W4","W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
```{r chancen, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r demokratie, echo=FALSE, fig.width=8, fig.height=5}  
...
lr_gen_w1 <- lr_gen_w1 %>% filter(!is.na(ver_gov)&!is.na(ver_ges)&!is.na(ver_par)&!is.na(ver_pol)&!is.na(ver_orf)) 

data_long <- gather(lr_gen_w1, condition, measurement, c(ver_gov,ver_ges,ver_par,ver_pol,ver_orf), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W1","W2","W4","W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
#                                "13.03.","16.04.","22.05.")
levels(data_plot_long$condition) <- c("Regierung","Gesundheitssystem","Parlament","Polizei","ORF")
...
#levels(data_plot_long_mean$wave) <-c("W1","W2","W4","W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
#levels(data_plot_long_mean$wave) <-c("28.03.","04.04.","17.04.","25.04.",
#                                "03.05.","09.05.","16.05.","24.05.","29.05.",
#                                "13.06.","27.06.","11.07.","15.08.","12.09.",
#                                "17.10.","14.11.","13.12","16.01.","13.02.",
#                                "13.03.","16.04.","22.05.")
levels(data_plot_long_mean$condition) <- c("Regierung","Gesundheitssystem","Parlament","Polizei","ORF")
...
```{r lebenszufr, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r bilanz, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r zufarbreg, echo=FALSE, fig.width=8, fig.height=5}  

# Zufriedenheit mit d. Arbeit der Regierung :###########################################################################
lr_gen_w1 <- bern_data_long2_factored %>% filter(!is.na(WEIGHTD)) # droppen der aussteiger 

data_long <- gather(lr_gen_w1, condition, measurement, c(zuf_reg_al,zuf_reg_un,zuf_reg_wi), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W3","W5","W8","W10","W13","W16","W19","W22")
levels(data_plot_long$condition) <- c("Bekämpfung der Arbeitslosigkeit","Stützung v. KMUs","Stützung der Wirtschaft")
...
#levels(data_plot_long_mean$wave) <-c("W3","W5","W8","W10","W13","W16","W19","W22")
levels(data_plot_long_mean$condition) <- c("Bekämpfung der Arbeitslosigkeit","Stützung v. KMUs","Stützung der Wirtschaft")
#levels(data_plot_long$measurement) <- c("sehr groß", "groß", "mittelmäßig", "klein", "sehr klein")
...
```{r effektiv, echo=FALSE,  fig.width=8, fig.height=5}  
...
```{r angemessen, echo=FALSE,  fig.width=8, fig.height=5}  
...
```{r skeptizismus blog2, echo=FALSE,include=FALSE, eval=FALSE,  fig.width=8, fig.height=5}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
```{r skeptizismus blog, echo=FALSE, include=FALSE, eval=FALSE, fig.width=8, fig.height=5}  
...
levels(data_plot_long$wave) <-c("W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
levels(data_plot_long$condition) <- c("Einschränkung v.\nKontakten",
                                      ...
                                      "Zutrittstests\nDienstleistungen") #"Zutrittstests\nVeranstaltungen","Zutrittstests\nGastro/Hotellerie",
...
ggplot(data_plot_long, aes(fill=measurement,x=wave, y=prop)) + 
 ...
 # geom_text(aes(label=round(prop*100, digits = 1)), position=position_stack(vjust=0.5), color="black", size=2) +
    ...
    guides(fill=guide_legend(ncol=6,nrow=2,byrow=TRUE)) + 
    scale_x_discrete(guide = guide_axis(n.dodge = 2))
ggsave("figure1_stack_geltung.png", units="in", width=10.5, height=7.5)
...
#levels(data_plot_long_mean$wave ) <- c("W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
```{r geltung_APA_DiD, echo=FALSE, fig.width=8, fig.height=5, include=FALSE, eval=FALSE}  
...
```{r dauer, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r finanz auskommen, echo=FALSE, fig.width=8, fig.height=5}  
...
#levels(data_plot_long_mean$wave ) <- c("W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
```{r finanz auskommen children, echo=FALSE,eval=FALSE,include=FALSE, fig.width=8,fig.height=5}  
...
```{r finanz auskommen single parent,eval=FALSE,include=FALSE,echo=FALSE, fig.width=8, fig.height=5}  
...
```{r masnahmen, echo=FALSE, fig.width=8, fig.height=5}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W1", "W2","W4","W6","W8","W10","W12","W17","W20","W23")
...
#levels(data_plot_long_mean$wave ) <- c("W1", "W2","W4","W6","W8","W10","W12","W17","W20","W23")
...
```{r compliance nach, echo=FALSE, fig.width=8, fig.height=5, include=TRUE}  
...
```{r solidaritat, echo=FALSE, fig.width=8, fig.height=5}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c( "W3","W6", "W9",  "W13", "W14", "W16", "W17", "W18","W21","W22","W23","W24")
...
#levels(data_plot_long_mean$wave) <-c( "W3","W6", "W9",  "W13", "W14", "W16", "W17", "W18","W21","W22","W23","W24")
...
```{r hausliche gewalt, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r alktabak, echo=FALSE, fig.width=8, fig.height=5}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W1", "W2","W4","W12","W16","W17","W20","W23")
...
#levels(data_plot_long_mean$wave ) <- c("W1", "W2","W4","W12","W16","W17","W20","W23")
...
```{r soznorm meinung anderer, echo=FALSE, fig.width=8, fig.height=5}  
...
data_long <- gather(lr_gen_w1, condition, measurement, c("sozialn_mein_and_abs","sozialn_mein_and_bes","sozialn_mein_and_ges","sozialn_mein_and_hau","sozialn_mein_and_sch","sozialn_mein_and_ver"), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W3","W7","W11","W14","W16","W18","W20","W22","W24")
...
ggplot(data_plot_long, aes(fill=measurement,x=wave, y=prop)) + 
    ...
    theme(legend.position="bottom",strip.text.x = element_text(size = 7)) + 
    guides(fill=guide_legend(ncol=3,nrow=2,byrow=TRUE)) 
ggsave("figure1_stack_soznorm_mein_andere.png", units="in", width=8, height=5, type="cairo-png")
...
ggplot(data_plot_long_mean, aes(wavedate, mean_measurement, colour = condition)) +
 ...
 #   theme(axis.text.x  = element_text(angle=45, hjust = 1)) +
    ...
    guides(colour=guide_legend(ncol=4,nrow=2,byrow=TRUE)) +
    scale_x_date(date_breaks = "month",date_labels = "%b-%y",guide = guide_axis(n.dodge = 2))
ggsave("figure1_mean_soznorm_mein_andere.png", units="in", width=8, height=5, type="cairo-png")
...
```{r soznorm verhalten anderer, echo=FALSE, fig.width=8, fig.height=5}  
...
data_long <- gather(lr_gen_w1, condition, measurement, c("sozialn_verh_and_abs", "sozialn_verh_and_hau","sozialn_verh_and_sch","sozialn_verh_and_ver"), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
#levels(data_plot_long_mean$wave ) <- c("W3","W7","W11","W14","W16","W18","W20","W22")
levels(data_plot_long_mean$condition) <- c("Alle halten\n1m Abstand","Alle bleiben\nzu Hause","Alle tragen\nSchutzmasken im\nöffentlichen Raum","Verletzungen\nwerden vermieden")#levels(data_plot_long$measurement) <- c("sehr groß", "groß", "mittelmäßig", "klein", "sehr klein")
...
```{r soznorm verhalten eigen, echo=FALSE,warning=FALSE, fig.width=8, fig.height=5}  
...
```{r soznorm meinung anderer einfach, echo=FALSE, fig.width=8, fig.height=5, include=FALSE, eval=FALSE}  
...
```{r soznorm verhalten anderer einfach, echo=FALSE, fig.width=8, fig.height=5, include=FALSE, eval=FALSE}  
...
```{r soznorm verhalten eigen einfach, echo=FALSE,warning=FALSE, fig.width=8, fig.height=5, include=FALSE, eval=FALSE}  
...
```{r stoppapp, echo=FALSE, fig.width=8, fig.height=5}  
...
```{r Besteuerung, echo=FALSE, fig.width=8, fig.height=5}  
#Besteuerung:##########################################################################################                                          
#tax_gleich
#tax_hurt
#tax_ineq
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W4","W10","W18","W24")
...
levels(data_plot_long_mean$wave ) <- c("W4","W10","W18","W24")
...
```{r Haushaltsgeraete, echo=FALSE, fig.width=8, fig.height=5}
...
```{r eureformen, echo=FALSE, fig.width=8, fig.height=5}
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W2", "W7", "W12", "W14","W21")
...
levels(data_plot_long_mean$wave ) <- c("W2", "W7", "W12", "W14","W21")
...
```{r krisenfinanzierung, echo=FALSE, fig.width=8, fig.height=5}
...
```{r preisherkunft, echo=FALSE, fig.width=8, fig.height=5}
...
```{r entscheidungskompetenz, echo=FALSE, fig.width=8, fig.height=5}
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W7","W14")
...
levels(data_plot_long_mean$wave ) <- c("W7","W14")
...
```{r Urlaubsplanung, echo=FALSE, fig.width=8, fig.height=5}
...
```{r Urlaubszeitpunkt, echo=FALSE, fig.width=8, fig.height=5}
...
```{r Urlaubsart, echo=FALSE, fig.width=8,eval=FALSE,include=FALSE, fig.height=5}
...
ggplot(data_plot_long, aes(x=wave, y=prop)) + 
    ...
    theme(legend.position="bottom") + 
    guides(fill=guide_legend(ncol=6,nrow=2,byrow=TRUE)) 
ggsave("figure1_side_urlaubart.png", units="in", width=8, height=5, type="cairo-png")
...
ggplot(data_plot_long_mean, aes(wave, prop, colour = condition)) +
  ...
  geom_errorbar(aes(ymin = ymin, ymax = ymax), width = 0.2,size=1.2) +
    scale_fill_brewer(palette = "RdYlBu") +  #alternative:Blues
    labs(y = "Einschätzung  \n (0 Plane Art von Urlaub nicht - 1 PLane Art von Urlaub)", x= "",colour="") +
 #   scale_y_continuous(labels = scales::percent) +
     theme_hc() +
 #   theme(axis.text.x  = element_text(angle=45, hjust = 1)) +
    theme(legend.position="bottom") + 
    guides(fill=guide_legend(ncol=5,nrow=1,byrow=TRUE)) 
ggsave("figure1_mean_urlaubart.png", units="in", width=8, height=5, type="cairo-png")

```


```{r Urlaubsziel, echo=FALSE, fig.width=8,eval=FALSE,include=FALSE, fig.height=5}
...
```{r Urlaubszielaut, echo=FALSE, eval=FALSE,include=FALSE,fig.width=8, fig.height=5}
...
```{r berufsaen, include = TRUE,echo=FALSE, fig.width=8, fig.height=5}  
...
```{r berufsstat, include = TRUE,echo=FALSE, fig.width=8, fig.height=5}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("Februar","W2", "W3","W4","W5","W6","W7","W8","W9","W10","W11","W12","W13","W14","W15","W16","W17","W18","W19","W20","W21","W22","W23","W24")
...
```{r Zeitverwend, include = TRUE,echo=FALSE, fig.width=8, fig.height=5}
# Zeitverwend###############################################################################
...
levels(data_plot_long_mean$wave ) <- c("W2", "W5","W8","W11","W14","W17","W20","W23")
...
```{r arbeitsl, include = TRUE,echo=FALSE, fig.width=8, fig.height=5,warning=FALSE,message=FALSE}
##arbeisl###############################################################################
...
levels(data_plot_long_mean$wave ) <- c("W10","W14","W20")
...
```{r issuebat, include = TRUE,echo=FALSE, fig.width=8, fig.height=5}
# ISSUEBATTERY###############################################################################
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W5","W9","W10","W13","W15","W20","W24")
...
levels(data_plot_long_mean$wave ) <- c("W5","W9","W10","W13","W15","W20","W24")
...
```{r welfshov, include = TRUE,echo=FALSE, fig.width=8, fig.height=5}
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W10","W14","W20")
...
```{r verreg, include = TRUE,echo=FALSE, fig.width=8, fig.height=5}
...
```{r staatmas, include = TRUE,echo=FALSE, fig.width=8, fig.height=5}
# Staatliche Maßnahmen -Arten Form und Zielgruppe###############################################################################
...
```{r arbeitsattributspraferenzen, echo=FALSE, fig.width=8, fig.height=5, results='asis'}
# Verantwortung der Regierung###############################################################################
...
data_long <- gather(lr_gen_w1, condition, measurement, c(joa_swc,joa_hin,joa_hel,joa_ind,joa_lea,joa_lei,joa_cre,joa_con,joa_int,joa_int), factor_key=TRUE)
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W13","W21")
...
levels(data_plot_long_mean$wave ) <- c("W11","W21")
...
ggplot(data_plot_long_mean, aes(condition, mean_measurement, colour=wave)) + #,color = condition
 ...
 #   theme(axis.text.x  = element_text(angle=45, hjust = 1)) +
    theme(legend.position="bottom") + 
    guides(color=guide_legend(ncol=4,nrow=3,byrow=TRUE)) 
ggsave("figure1_mean_jobattribp.png", units="in", width=8, height=5, type="cairo-png")
```

### Arbeitswerte

```{r arbeitswerte, echo=FALSE, fig.width=8, fig.height=5, results='asis'}
# Verantwortung der Regierung###############################################################################
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W11","W21")
...
```{r lotto, echo=FALSE, fig.width=8, fig.height=5, results='asis'}
# lotto Frage###############################################################################
...
```{r arbeitsbedienungen, echo=FALSE, fig.width=8, fig.height=5, results='asis'}
...
levels(data_plot_long$wave) <-c("W11","W14","W21")
...
levels(data_plot_long_mean$wave ) <- c("W11","W14","W21")
...
```{r zuflebesb, echo=FALSE, fig.width=8, fig.height=5}  
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W5","W10","W13","W16","W19","W22","W24")
...
levels(data_plot_long_mean$wave ) <- c("W5","W10","W13","W16","W19","W22","W24")
...
```{r risikobereit, echo=FALSE, fig.width=8, fig.height=5}  


#risikobereitschaft ##########################################################################
lr_gen_w1 <- bern_data_long2_factored %>% filter(!is.na(WEIGHTD)) # droppen der aussteiger 

data_long <- gather(lr_gen_w1, condition, measurement, risikob, factor_key=TRUE) %>% filter(wave %in% c(1,6,11,13,15,18,21,24) & measurement!="88") # only waves where the full sample received the questions
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W1","W6","W11","W13","W15","W18","W21","W24")
...
levels(data_plot_long_mean$wave ) <- c("W1","W6","W11","W13","W15","W18","W21","W24")
...
```{r loc, echo=FALSE, fig.width=8, fig.height=5}  


#Locus of control ##########################################################################
lr_gen_w1 <- bern_data_long2_factored %>% filter(!is.na(WEIGHTD)) # droppen der aussteiger 

data_long <- gather(lr_gen_w1, condition, measurement, c(psy_leb,psy_bel,psy_fbe,psy_sci), factor_key=TRUE) %>% filter(wave %in% c(1,6,11,13,15,18,21,24) & measurement!="keine Angabe" & measurement!="Weiss nicht") #only waves where the full sample received the questions
data_long$measurement<-as.factor(data_long$measurement)
...
data_plot_long$wave<-as.factor(data_plot_long$wave)
levels(data_plot_long$wave) <-c("W1","W6","W13","W15","W18","W21","W24")#"W11"
...
levels(data_plot_long_mean$wave ) <- c("W1","W6","W13","W15","W18","W21","W24")#"W11"
...
```{r bundeslaenderanalysen, echo=FALSE, fig.width=8, fig.height=5, results='asis'}
#GESUNDHEITLICH#########################

lr_gen_w1 <- bern_data_long2_factored %>% filter(ges_per_gefahr!=99 & ges_pub_gefahr!=99) %>% ungroup() %>%
  mutate(wave= as_factor(as.character(wave)),ges_per_gefahr = as_factor(ges_per_gefahr),ges_pub_gefahr = as_factor(ges_pub_gefahr)) 
...
lr_gen_w1 <- bern_data_long2_factored %>% filter(wir_per_gefahr!=99 & wir_pub_gefahr!=99) %>% ungroup() %>%
  mutate(wave= as_factor(as.character(wave)),wir_per_gefahr = as_factor(wir_per_gefahr),wir_pub_gefahr = as_factor(wir_pub_gefahr)) 
