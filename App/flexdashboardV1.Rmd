...
data$subgroup<-fct_relevel(data$subgroup,"<30","30-59",">60","1.Quintile","2.Quintile","3.Quintile","4.Quintile","5.Quintile","primary","Lehre","secondary","tertiary")
levels(data$subgroup)<- c("<30","30-59",">60","1.Quintil","2.Quintil","3.Quintil","4.Quintil","5.Quintil", "primär","Lehre","sekundär","tertiär","BG","weiblich","KT","männlich","NÖ","keine","OÖ","SB","ST","TI","VB","WI" )
...
selectInput("groupby", label = "Gruppieren nach:",
            choices = c("Keine","Geschlecht", "Alter", "Bildungsgrad", "Region","Einkommen"), selected = "Geschlecht")
