...
data <-readr::read_csv("https://raw.githubusercontent.com/fabiankal/woco/beta/output/tables/export_shiny_data.csv",show_col_types = FALSE)

#data with shares of answer categories
data_shares <-readr::read_csv("https://raw.githubusercontent.com/fabiankal/woco/beta/output/tables/export_shiny_data_shares.csv",show_col_types = FALSE)

#variable labels
data_labels <-readr::read_csv("https://raw.githubusercontent.com/fabiankal/woco/beta/output/tables/data_labels_cq.csv",show_col_types = FALSE)
data_labels$scalenumber=data_labels$scalenumber+1

#covid cases
epidf       <-readr::read_csv("https://raw.githubusercontent.com/fabiankal/woco/beta/output/tables/CovidFaelle_Timeline.csv",show_col_types = FALSE)
