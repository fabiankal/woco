...
sociodem <-c("WEIGHTD","wave","wavedate","gender","alter_g","edu4","bula","hh_inc_cur_quintile")
...
grouped_labels<- df %>% mutate(ID = group_indices(.,V1,V2,V3,V4,V5,V6,V7)) %>% mutate(variable=rownames(.))
...
data_plot_long_mean[[val]] <- out[[val]]  %>% filter(!is.na(measurement)) %>%
  ...
  summarise(mean_measurement=survey_mean((as.numeric(as.factor(measurement)))-min(as.numeric(as.factor(measurement))),vartype = c("se"))) %>% group_by(wavedate,variable) %>%
...
data_plot_long_mean_ge[[val]] <- out[[val]]  %>% filter(!is.na(measurement)&!is.na(gender)) %>%
  ...
  summarise(mean_measurement=survey_mean((as.numeric(as.factor(measurement)))-min(as.numeric(as.factor(measurement))),vartype = c("se"))) %>% group_by(wavedate,variable,gender) %>%
...
data_plot_long_mean_ag[[val]] <- out[[val]]  %>% filter(!is.na(measurement)&!is.na(alter_g)) %>%
  ...
  summarise(mean_measurement=survey_mean((as.numeric(as.factor(measurement)))-min(as.numeric(as.factor(measurement))),vartype = c("se"))) %>% group_by(wavedate,variable,alter_g) %>%
...
data_plot_long_mean_ed[[val]] <- out[[val]]  %>% filter(!is.na(measurement)&!is.na(edu4)) %>%
  ...
  summarise(mean_measurement=survey_mean((as.numeric(as.factor(measurement)))-min(as.numeric(as.factor(measurement))),vartype = c("se"))) %>% group_by(wavedate,variable,edu4) %>%
     mutate(ymax=mean_measurement+1.96*mean_measurement_se, ymin=mean_measurement-1.96*mean_measurement_se,groupby="ed")

#mean by Region
data_plot_long_mean_bl[[val]] <- out[[val]]  %>% filter(!is.na(measurement)&!is.na(bula)) %>%
  as_survey_design(weights = c(WEIGHTD)) %>%
  group_by(wavedate,variable,bula) %>%
  summarise(mean_measurement=survey_mean((as.numeric(as.factor(measurement)))-min(as.numeric(as.factor(measurement))),vartype = c("se"))) %>% group_by(wavedate,variable,bula) %>%
...
data_plot_long_mean_hi[[val]] <- out[[val]]  %>% filter(!is.na(measurement)&!is.na(hh_inc_cur_quintile)) %>%
  as_survey_design(weights = c(WEIGHTD)) %>%
  group_by(wavedate,variable,hh_inc_cur_quintile) %>%
  summarise(mean_measurement=survey_mean((as.numeric(as.factor(measurement)))-min(as.numeric(as.factor(measurement))),vartype = c("se"))) %>% group_by(wavedate,variable,hh_inc_cur_quintile) %>%
...
data_plot_long_mean_bl_new<-bind_rows(data_plot_long_mean_bl, .id = 'scales')%>%rename("subgroup" = bula)
data_plot_long_mean_hi_new<-bind_rows(data_plot_long_mean_hi, .id = 'scales')%>%rename("subgroup" = hh_inc_cur_quintile)
