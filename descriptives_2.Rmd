...
variable_doc = read_excel("Y:/Wirtschaftssoziologie/Corona/Daten downloaded/Daten Welle 24/ACPP_Documentation/W1-24_ACPP_Variablelist_V20210702.xlsx",sheet = "Variable List")
...
```{r variable labels and scales, echo=FALSE, fig.width=8, fig.height=5, results='asis'}

#needed is table with variable names and according:
#1 variable labels
#2 value labels
#2 scales
#+english translation
...
write_csv(grouped_labels, "./output/tables/grouped_labels.csv", na = "NA")
